...
#elif defined EMPL_TARGET_RTT
#include <rtt_mpu_adpt.h>
#define DBG_LVL     GLOBAL_DBG_LVL
#define LOG_TAG     "mpu"
#include <rtdbg.h>
#define i2c_write   rt_mpu_i2c_write
#define i2c_read    rt_mpu_i2c_read
#define delay_ms    rt_thread_mdelay
#define get_ms      rt_get_uptime_ms
#define log_i       LOG_I
#define log_e       LOG_E
#define min(a,b)    ((a<b)?a:b)
